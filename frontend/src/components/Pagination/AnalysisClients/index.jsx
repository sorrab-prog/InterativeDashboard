        ...
        <Container fluid className="onboarding-container">
            ...
            <Row className="list-row">
                ...
                <Col className="list-col">
                    ...
                    {filtered_itens.map(item => {
                        return <p className="analysis">Em análise</p>
                    })}
                </Col>
                <Col className="list-col">
                    <h1>Análise de Situação Cadastral</h1>
                    {filtered_itens.map(item => {
                        return <p className="incomplete">Reprovado</p>
                    })}
                </Col>
                <Col className="list-col">
                    <h1>Análise Jurídica</h1>
                    {filtered_itens.map(item => {
                        return <p className="complete">Aprovado</p>
                    })}
                </Col>
            </Row>
        </Container>
